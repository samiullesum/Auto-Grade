...
import { uploadProjectMarks } from "../../../actions/courseActions";
...
class UploadProject extends Component {
    ...
    handleProjectFileLoad = (data) => {
        ...
        //console.log(marks);
        this.setState({ Project: marks })

    }
    handleUploadProjectMarks = (e) => {
        e.preventDefault();
        const marks = {
        ...
        return (
            <Container fluid="md">
                <Row style={{ marginTop: "5vw" }}>
                    <Col md="8">
                        <div><h1 style={{ marginBottom: "3vw" }}><Badge bg="primary">Upload Project Marks</Badge></h1></div>
                        <Form>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control as="select" onChange={this.handleChange} id="projectTitle">
                            ...
                            <Form.Group className="mb-3">
                                <Form.Label>Upload a list of Project marks</Form.Label>
                                <CSVReader
                                    ref={buttonRef}
                                    onFileLoad={this.handleProjectFileLoad}
                                    onError={this.handleOnError}
                                    noClick
                                    noDrag
                                    onRemoveFile={this.handleProjectRemoveFile}
                                >
                                    {({ file }) => (
                                        <aside
                                            style={{
                        ...
                        <Button variant="primary" type="submit" style={{ height: '45px', marginTop: '3vw' }} onClick={this.handleUploadProjectMarks}>
...
export default connect(mapStateToProps)(UploadProject);