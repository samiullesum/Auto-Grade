...
import { uploadFinalMarks } from "../../../actions/courseActions";
...
class UploadFinal extends Component {
    ...
    handleFinalFileLoad = (data) => {
        ...
        //console.log(marks);
        this.setState({ Final: marks })

    }
    handleUploadFinalMarks = (e) => {
        e.preventDefault();
        const marks = {
            title: this.state.finalTitle,
        ...
        return (
            <Container fluid="md">
                <Row style={{ marginTop: "5vw" }}>
                    <Col md="8">
                        <div><h1 style={{ marginBottom: "3vw" }}><Badge bg="primary">Upload Final Marks</Badge></h1></div>
                        <Form>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Group className="mb-3">
                                <Form.Label>Upload a list of Final marks</Form.Label>
                                <CSVReader
                                    ref={buttonRef}
                                    onFileLoad={this.handleFinalFileLoad}
                                    onError={this.handleOnError}
                                    noClick
                                    noDrag
                                    onRemoveFile={this.handleFinalRemoveFile}
                                >
                                    {({ file }) => (
                                        <aside
                                            style={{
                        ...
                        <Button variant="primary" type="submit" style={{ height: '45px', marginTop: '3vw' }} onClick={this.handleUploadFinalMarks}>
                            Upload Final Marks
                        </Button>
                    </Col>
                    <Col md={4}>
...
export default connect(mapStateToProps)(UploadFinal);
